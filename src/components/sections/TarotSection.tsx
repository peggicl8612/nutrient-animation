      ...
      <div className="section-tarot-inner">
        ...
        >
          ...
          <p className="section-desc">
            分析完成後，宇宙為你抽出一張專屬牌面。翻開它，閱讀今日營養的詩意註腳。
          </p>
        </motion.header>
        ...
        <div className="tarot-stage">
          ...
          {card && (
            ...
            >
              <h3 className="tarot-reading-title">{card.title}</h3>
              <p className="tarot-reading-text">{card.description}</p>
            </motion.div>
          )}
        </div>
      </div>

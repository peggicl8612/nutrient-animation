...
export const MEAL_COLORS: Record<MealType, MealColorToken> = {
  breakfast: { primary: '#F3E7C4', glow: 'rgba(243, 231, 196, 0.55)', label: '早餐' },
  lunch: { primary: '#E8F0D8', glow: 'rgba(232, 240, 216, 0.55)', label: '午餐' },
  snack: { primary: '#F5E6DC', glow: 'rgba(245, 230, 220, 0.55)', label: '點心' },
  dinner: { primary: '#E4E0F0', glow: 'rgba(228, 224, 240, 0.55)', label: '晚餐' },
  night: { primary: '#D8E4F0', glow: 'rgba(216, 228, 240, 0.55)', label: '宵夜' },
};
